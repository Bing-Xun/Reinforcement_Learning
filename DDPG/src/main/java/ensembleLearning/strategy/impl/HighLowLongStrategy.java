...
public class HighLowLongStrategy implements Strategy {

    private String strategyName = "HighLowLongStrategy";

    private HighLowTradingVO predict(double[] prices) {
        // 生成交易信號
        HighLowTradingVO signals = HighLowLongTrading.generateSignals(prices);
        return signals;
    }
