...
import feature.HighLowShortTrading;

import java.util.List;

public class HighLowShortStrategy implements Strategy {

    private String strategyName = "HighLowShortStrategy";

    private HighLowTradingVO predict(double[] prices) {
        // 生成交易信號
        HighLowTradingVO signals = HighLowShortTrading.generateSignals(prices);
        return signals;
    }
